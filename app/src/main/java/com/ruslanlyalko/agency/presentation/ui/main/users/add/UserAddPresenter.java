package com.ruslanlyalko.agency.presentation.ui.main.users.add;
...
import static com.ruslanlyalko.agency.data.Config.API_KEY;
import static com.ruslanlyalko.agency.data.Config.APP_ID;
import static com.ruslanlyalko.agency.data.Config.APP_NAME;
import static com.ruslanlyalko.agency.data.Config.DATABASE_URL;
...
public class UserAddPresenter extends BasePresenter<UserAddView> {
    ...
    public void onRegister(Context context, String email, String password, String name, String phone, final boolean registerAndLogin) {
